...
function buildAdvertiserForm($aAdvertiser)
{
	...
	$form->addElement('text','Phone no.',$GLOBALS['strPhoneno']);/* added */
    ...
    $form->addRule('Phoneno', "Phone Number Required", 'required');/* added */
    $form->addRule('Phoneno', "Please enter valid phone number", 'Phoneno');/* added */    
